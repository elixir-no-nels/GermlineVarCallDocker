...
# Software installed
LABEL soft.Picard="2.8.x"
LABEL soft.varscan="2.3.x"
...
#-------------- Install Picard
RUN wget https://github.com/broadinstitute/picard/releases/download/2.8.3/picard.jar -O /Jar/picard.jar


#-------------- Install VarScan
RUN wget https://downloads.sourceforge.net/project/varscan/VarScan.v2.3.9.jar -O /Jar/VarScan.jar
