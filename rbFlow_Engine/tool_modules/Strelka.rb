...
class Strelka < Toolbase
  ...
  def get_config_template
    erb_template = %~
     ...
     # Strelka conf
     isSkipDepthFilters                 = <%= @opt_parser.get from: 'isSkipDepthFilters'                 , default_value: 0,         required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     maxInputDepth                      = <%= @opt_parser.get from: 'maxInputDepth'                      , default_value: 10000,     required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     ...
     indelMaxIntHpolLength              = <%= @opt_parser.get from: 'indelMaxIntHpolLength'              , default_value: 14,        required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     indelMaxRefRepeat                  = <%= @opt_parser.get from: 'indelMaxRefRepeat'                  , default_value: 8,         required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     ...
     minTier1Mapq                       = <%= @opt_parser.get from: 'minTier1Mapq'                       , default_value: 20,        required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     minTier2Mapq                       = <%= @opt_parser.get from: 'minTier2Mapq'                       , default_value: 5,         required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     ssnvQuality_LowerBound             = <%= @opt_parser.get from: 'ssnvQuality_LowerBound'             , default_value: 15,        required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     sindelQuality_LowerBound           = <%= @opt_parser.get from: 'sindelQuality_LowerBound'           , default_value: 30,        required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     isWriteRealignedBam                = <%= @opt_parser.get from: 'isWriteRealignedBam'                , default_value: 0,         required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
     binSize                            = <%= @opt_parser.get from: 'binSize'                            , default_value: 25000000,  required: false, type: Fixnum, comment: 'To change this parameter in the Strelka conf file' %>
